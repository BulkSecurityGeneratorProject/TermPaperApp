package ru.eltech.termpaper.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(ru.eltech.termpaper.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(ru.eltech.termpaper.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
