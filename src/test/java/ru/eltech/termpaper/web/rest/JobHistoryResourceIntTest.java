...
import ru.eltech.termpaper.repository.JobHistoryRepository;
import ru.eltech.termpaper.repository.search.JobHistorySearchRepository;
import ru.eltech.termpaper.service.JobHistoryService;
...
import static ru.eltech.termpaper.web.rest.TestUtil.createFormattingConversionService;
...
import ru.eltech.termpaper.domain.enumeration.Language;
/**
...
public class JobHistoryResourceIntTest {
     ...
     *
     * @see ru.eltech.termpaper.repository.search.JobHistorySearchRepositoryMockConfiguration
     */
    @Autowired
